          ...
          <div className="flex items-center gap-1">
            ...
            <div className="relative ml-3" ref={menuRef}>
              <button
                ...
                className="w-9 h-9 rounded-full bg-[#D92D27] border-2 border-white flex items-center justify-center text-sm font-medium text-white hover:bg-[#b82420] transition-colors focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-[#0C2340]"
              >
                {initials}
              </button>
